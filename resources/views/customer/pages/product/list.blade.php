      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4">
          <div class="card text-black">
            ...
            <div class="">
              <form action="{{ url('back-customer/product/'.$item->id) }}" method="post" class="d-flex">
              @csrf
              <a href='{{ url('/back-customer/product/'.$item->id.'/detail-product') }}' class="btn btn-success mt-10">Detail</a>              <div class="d-flex ml-10">
                <div class="mt-10">
                  <input type="number" id="jumlah_pesanan" name="jumlah_pesanan" value="1" min="1" required class="w-20 text-">
                </div>
