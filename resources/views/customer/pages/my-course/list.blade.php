...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Home - Kelas (Course) - </span>&nbsp;Kelas Saya</h1>
        </div>
    </div>
</div>
@endsection
                                    ...
                                    <div class="d-flex justify-content-between align-items-start flex-wrap">
                                        <div class="d-flex flex-column w-75">
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="{{url('/back-customer/my-course/'.$item->slug.'/course')}}" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{$item->course_name}}</a>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="{{url('/back-customer/my-course/'.$item->slug.'/course')}}" class="text-gray-600 text-hover-primary fs-2 fw-bolder me-1">Rp.{{$item->harga}}</a>
                                            </div>
                                        </div>
                                        <div class="d-flex my-4">
                                            <a href="{{url('/back-customer/my-course/'.$item->slug.'/course')}}" class="btn btn-sm btn-primary me-2">Lihat Detail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
