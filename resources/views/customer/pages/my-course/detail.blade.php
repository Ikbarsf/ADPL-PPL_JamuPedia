...
@section('toolbar')
<div class="toolbar-fixed bg-white" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <a href={{ url("/back-customer/course/list-course") }}><button type="button" class="btn btn-outline-dark pr-10">Back<button><a>            
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">{{$getCourse->course_name}} - </span>&nbsp;Tentang Materi</h1>
        </div>
    </div>
</div>
@endsection
