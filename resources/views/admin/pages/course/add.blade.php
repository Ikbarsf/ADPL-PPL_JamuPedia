...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Home - Kelas (Course) - </span>&nbsp;Tambah Kelas</h1>
        </div>
            ...
            <div id="kt_account_settings_profile_details" >
                <form id="kt_account_profile_details_form" class="form" method="POST" action="{{url('/back-admin/course/store-course')}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label required fw-bold fs-6">Harga Course</label>
                            <div class="col-lg-8 fv-row">
                                <input type="number" id="currency" name="harga" min="0" class="harga form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('harga') is-invalid @enderror" placeholder="Harga Course" />
                                @error('harga')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
