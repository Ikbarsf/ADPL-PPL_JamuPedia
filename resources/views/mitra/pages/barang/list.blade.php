...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Home - Master Data - Produk - </span>&nbsp;List Produk</h1>
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <p class="fw-bolder ms-3" data-kt-ecommerce-product-filter="category_name">{{ $item->expired }}</p>
                        </td>
                        <td class="text-center">
                            <p class="fw-bolder ms-3" data-kt-ecommerce-product-filter="category_name">{{ $item->category_id }}</p>
                        </td>
                        <td class="text-center">
                            <p class="fw-bolder ms-3" data-kt-ecommerce-product-filter="category_name">{{ $item->decription }}</p>
                        </td>
                        <td class="text-center">
