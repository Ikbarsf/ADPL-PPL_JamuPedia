    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details">
                <form id="kt_account_profile_details_form" class="form" method="POST" action="{{url('/back-mitra/E-Commers/store-product')}}" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="number" id="currency" name="harga" min="0" class="harga form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('harga') is-invalid @enderror" placeholder="Harga Produk" />
                                @error('harga')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select class="form-select form-control form-control-lg form-control-solid mb-3 mb-lg-0" id="product_category_id" name="product_category_id" aria-label="Default select example">
